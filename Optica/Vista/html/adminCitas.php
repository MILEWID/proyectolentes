...
<?php include "menu.php" ?>
    <div class="container">
        ...
        <div class="row justify-content-end">
            <a href="" type="button" class="btn btn-primary col-2">
                ...
                AGREGAR</a>
            <button type="button" href="<?php echo URL; ?>citas/BuscarCitas.html" class="btn btn-dark col-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
