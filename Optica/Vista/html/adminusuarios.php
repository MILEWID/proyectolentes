                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#eliminarModal" href="<?php echo URL; ?>usuario/eliminarControlador?id=<?php echo $row['idUsuario']; ?>">  eliminar </button>
