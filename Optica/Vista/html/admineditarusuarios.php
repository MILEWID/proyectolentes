...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <form action="<?php echo URL;?>usuario/modificarControlador" method="POST">
        ...
        <button class="btn btn-primary edition" href="<?php echo URL ?>/usuario/modificarControlador" type="submit">GUARDAR DATOS</button>
        <a class="btn btn-dark">CANCELAR</a>
        </form>
    </div>
    </div>
