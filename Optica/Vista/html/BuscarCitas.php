...
<?php include "menu.php" ?>
    <div class="container">
        ...
        <a href="<?php echo URL ?>/citas/mostrarcontrolador" class="btn btn-primary" type="submit">LISTO</a>
        <a class="btn btn-dark" href="<?php echo URL ?>/citas/mostrarcontrolador">CANCELAR</a>
        </form>
    </div>
    </div>
