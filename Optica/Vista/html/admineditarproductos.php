                ...
                <class class="form-row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control " name="validationServer01" value="<?php echo $_GET['name'] ?>" id="idNombre" placeholder="lentes" pattern="[a-zA-Z ]{2,100}" title="debe ingresar letras de 2 a 100 caracteres" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <!-- is-valid es una clase para validar campos -->
                            <input type="text" class="form-control" value="<?php echo $_GET['marca'] ?>" name="validationServer02" id="idMarca" placeholder="vitalia" pattern="[a-zA-Z ]{2,100}" title="debe ingresar letras de 2 a 100 caracteres" required>
                            <div class="valid-feedback">
                                Es correcto
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <!-- is-valid es una clase para validar campos -->
                            <input type="number" class="form-control" value="<?php echo $_GET['precio'] ?>" name="validationServer04" id="idPrecio" placeholder="5$" min="10" max="500" required>
                            <div class="valid-feedback">
                                Es correcto
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <!-- is-valid es una clase para validar campos -->
                            <input type="text" class="form-control" value="<?php echo $_GET['material'] ?>" name="validationServer05" id="idMaterial" placeholder="lino" pattern="[a-zA-Z ]{2,100}" title="debe ingresar letras de 2 a 50 caracteres" required>
                            <div class="valid-feedback">
                                Es correcto
                            </div>
                            <div class="invalid-feedback">
